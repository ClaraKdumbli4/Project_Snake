...
int historia(){ //LISTAR OS MAIORES RECORDES JOGADOS;
	textcolor(3);
	gotoxy(8,4);printf("EM UM MUNDO UM TANTO QUANTO ESQUISITO.....");
	textcolor(7);
	gotoxy(8,6);printf("Contaremos a história de uma pobre cobra chamada Startênia, que vive no auge da sua adolescência e ");
	gotoxy(8,7);printf("surpreende-se com a terrível descoberta de que seus pais verdadeiros não são os que lhe criaram a vida");
	gotoxy(8,8);printf("toda. Sem saber como lidar com essa terrível notícia, ela foge de casa e desbrava o mundo atrás de ");
	gotoxy(8,9);printf("saber quem são seus verdadeiros pais, sobrevivendo e crescendo apenas com umas maçãs que vai achando ");
	gotoxy(8,10);printf("pelo caminho…");
	gotoxy(8,12);printf("Você conseguirá ajudar a coitada da Startênia a chegar no seu objetivo ou vai deixar ela morrer ");
	gotoxy(8,13);printf("desolada e sem pais por esse mundo tão cruel que a gente vive??");
	gotoxy(1,30);
    return 0;
}
